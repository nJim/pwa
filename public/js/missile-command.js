...
const cityWidth = 25;  // how wide a city rect is
const cityHeight = 15;  // how tall a city rect is
const cityY = groundY - cityHeight;  // y position of the city
const siloY = groundY - 20;  // y position of the top of the silo
...
let cities = [
  ...
  { x: 200, y: cityY, alive: true },
  { x: 260, y: cityY, alive: true },
  { x: 420, y: cityY, alive: true },
  { x: 480, y: cityY, alive: true },
  { x: 540, y: cityY, alive: true }
];

// the x position of each of the 3 silos
const siloPos = [ 55, canvas.width / 2, 615 ];
